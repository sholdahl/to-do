...
const createDom = {
  ...
  createGroupDom: (group) => {
    ...
    todoHeaderPriority.classList.add(
      "col-2",
      "todo-table-title",
      "todo-priority-title",
      "d-none",
    ...
    todoHeaderDueDate.classList.add(
      "col-3",
      "col-md-2",
      "todo-table-title",
      "todo-due-title-date",
...
const render = {
  ...
  editTaskForm: (e) => {
    ...
    taskTitleDisplay.dataset.taskIndex = taskIndex;
...
const setUpListeners = {
  ...
  editTaskForm: () => {
    ...
    let editTaskDeleteBtn = document.querySelector("#delete-task-form-btn");
